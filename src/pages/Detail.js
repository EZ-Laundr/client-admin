							...
							<div className="container px-5 py-10 mx-auto">
								{isLoadingOrder ? (
									<div className="flex justify-center items-center h-96">
										<img
											src="https://i.ibb.co/mGH9RHc/logo-dashboard-removebg-preview.png"
									...
									<div>
										<h1 className="sm:text-3xl text-2xl font-medium title-font mb-10 text-gray-900 flex justify-center">
											Detail Order
										</h1>
											...
											<div className=" w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
												<div className="flex justify-between">
													...
													<div className="text-gray-900 text-xl title-font font-medium mb-4">
														Status :{" "}
														<div class="badge badge-accent p-5">{status}</div>
													</div>
												</div>
												<div className="text-lg title-font  tracking-widest mb-4">
													Service: {service} | {formatPrice(priceService)} /kg
													<i className="text-green-500 fa-lg far fa-check-circle"></i>
												</div>
												<div className="text-lg title-font  tracking-widest mb-4">
													Perfume: {perfume} | {formatPrice(perfumePrice)}{" "}
													<i className="text-green-500 fa-lg far fa-check-circle"></i>
												</div>
												<div className="text-lg title-font  tracking-widest mb-4">
													Antar Jemput
