                        ...
                        <div class="text-gray-600 body-font relative">
                            <div class="container px-5 py-20 mx-auto">
                                <div class="flex flex-col text-center w-full">
                                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Edit Special Treatment</h1>
                                </div>
                                <div class="lg:w-1/2 md:w-2/3 w-3/4 border shadow-xl rounded-xl border-indigo-500 p-5 mx-auto">
                                    <div class="flex flex-col flex-wrap ">
                                        ...
                                        <div class="p-2 w-full">
                                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Edit Special Treatment</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
